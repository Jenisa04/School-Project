...
import java.util.List;
    ...
    public class adapter_demo extends RecyclerView.Adapter<adapter_demo.ViewHolder> {
        ...
        public adapter_demo(List<fds_item> items, OnItemClickListener listener) {
            this.items = items;
            this.listener = listener;
        }

        @Override public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
            View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.fds_list, viewGroup, false);
