...
public class mds_adapter extends RecyclerView.Adapter<mds_adapter.ViewHolder> {

    public interface OnItemClickListener {
        void onItemClick(mds_item item);
    }

    private final List<mds_item> items;
    private final OnItemClickListener listener;

    public mds_adapter(List<mds_item> items, OnItemClickListener listener) {
        this.items=items;
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(final mds_item item, final OnItemClickListener listener) {
